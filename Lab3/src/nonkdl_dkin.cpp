...
int main(int argc, char **argv)
{
        ...
        while(ros::ok())
        {
                ...
                double x = a2*cos(desired_position[0]-desired_position[1])+a1*cos(desired_position[0]);
                double y = -a2*sin(desired_position[0]-desired_position[1])-a1*sin(desired_position[0]);
